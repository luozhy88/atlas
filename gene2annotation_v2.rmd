...
colnames(Nmapped_count) <- attributes$sample_names
...
write.csv(KEGG_Module_c2.modules,file = "Genecatalog/annotations/KEGG_Module_count_grouped_step_coverage0.8.csv",row.names = F,quote = F)
```
